...
async function main() {
  ...
  const cryptoPoker = await CryptoPoker.deploy('Test NFT', 'TNF', 'http://www.baidu.com');
  // const cryptoPoker = await upgrades.deployProxy(CryptoPoker, ['Test NFT', 'TNF', 'http://www.baidu.com'], { initializer: 'initialize' });
  await cryptoPoker.deployed();
  console.log("CryptoPoker deployed to: ", cryptoPoker.address);
